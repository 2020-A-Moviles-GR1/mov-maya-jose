...
class Tienda private constructor(var nombreDepartamento:String,
                                 var ciudad:String,
                                 var estado:Boolean,
                                 var numero: Double,
    ...
    companion object {
        var count: Int = 0
        private fun create(nombreDepartamento:String, ciudad:String,estado:Boolean, numero: Double,codDepartamento: Int): Tienda = Tienda(nombreDepartamento,  ciudad,estado, numero, codDepartamento)
        ...
        fun insertarDatos(nombreDepartamento:String, ciudad:String,estado:Boolean, numero: Double,codDepartamento: Int){
            val ingresoDatos = Tienda.create(nombreDepartamento,  ciudad,estado, numero, codDepartamento)
            ...
            while (st.hasMoreTokens()) {
                if((count%5)==0) {
                    if(codDepartamento==codDepa){
                        Cliente.borrarEnCascade(codDepa)
                        delete(count2)
                    }
                    count2++
                }
