...
class Cliente private constructor(var codEmpleado: Int,
    ...
    companion object {
        var count: Int = 0
        private fun create(codEmpleado: Int, nombreEmpleado:String, sueldo: Double, fechaNacimiento: Date, estado:Boolean, codDepartamento: Int): Cliente = Cliente(codEmpleado, nombreEmpleado, sueldo, fechaNacimiento, estado, codDepartamento)
        ...
        fun insertarDatos(codEmpleado: Int, nombreEmpleado:String, sueldo: Double, fechaNacimiento: Date, estado:Boolean, codDepartamento: Int){
            val ingresoDatos = Cliente.create(codEmpleado, nombreEmpleado, sueldo, fechaNacimiento, estado,codDepartamento)
